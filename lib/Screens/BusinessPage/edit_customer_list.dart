...
class EditCustomerList extends StatelessWidget {
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    return InkWell(
                                      ...
                                      onTap: (){
                                        editInvoiceCustomer(businessCustomers[index], context);
                                      },
                                    );
                                  }),
                            ),
  ...
  editInvoiceCustomer(Customer customer, context){
    final invoiceCustomerProvider = StoreProvider.of<AppState>(context);
    invoiceCustomerProvider.dispatch(customerAction.EditInvoiceCustomer(payload: customer));
