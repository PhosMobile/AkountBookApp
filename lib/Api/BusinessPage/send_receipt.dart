...
class _SendReceiptState extends State<SendReceipt> {
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                "Send via (select means of  sending Receipt",
                          ...
                          state.invoiceReceipt != null
                              ? Card(
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                      "Balance ${CurrencyConverter().formatPrice(_invoiceBalance, state.currentBusiness.currency)}",
                                      textAlign: TextAlign.left,
                                    ),
                                  ),
                                  color: Colors.white,
  ...
  _sendReceipt(context, Receipt receipt, Customer customer, Invoice invoice) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ReceiptSent(customer: customer)),
    );
  }
